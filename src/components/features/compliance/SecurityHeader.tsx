    ...
    <div className="flex justify-between items-end">
      <div>
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-3xl font-black text-text-primary tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-bg-secondary to-text-muted">合规与安全中心</h2>
      ...
      <div className="flex gap-4">
        <div className="flex items-center gap-6 px-6 py-3 bg-bg-secondary border border-border-default rounded-2xl">
        ...
        <button className="px-6 py-3 bg-indigo-600 text-white rounded-xl text-xs font-black shadow-lg shadow-indigo-600/20 flex items-center gap-2 hover:scale-105 transition-all duration-300 uppercase tracking-widest">
