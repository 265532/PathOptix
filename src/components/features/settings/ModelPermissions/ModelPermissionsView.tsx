    ...
    <div className="p-10 space-y-10 animate-in slide-in-from-right-4 duration-500 max-w-6xl mx-auto pb-24">
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-black text-text-primary tracking-tight italic">模型训练与权重权限管理</h2>
            <p className="text-[10px] text-text-muted font-black uppercase tracking-widest mt-1">Deep Reinforcement Learning Access Governance</p>
          </div>
        </div>
        <div className="flex gap-4">
           <button className="flex items-center gap-2 px-6 py-3 bg-bg-secondary border border-border-default text-text-muted text-xs font-black rounded-xl hover:text-text-primary transition-all duration-300 uppercase tracking-widest">
             <ShieldCheck size={14} /> 紧急全域加锁
           </button>
           <button className="px-10 py-3 bg-indigo-600 text-white text-xs font-black rounded-xl shadow-lg shadow-indigo-600/30 hover:scale-105 active:scale-95 transition-all duration-300 flex items-center gap-2 uppercase tracking-widest">
             <Save size={14} /> 应用权限更改
           </button>
        </div>
      </div>
